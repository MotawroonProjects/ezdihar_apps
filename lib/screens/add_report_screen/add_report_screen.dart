...
import 'cubit/add_report_cubit.dart';

class AddReportScreen extends StatefulWidget {
  final ProviderOrder model;

  const AddReportScreen({Key? key, required this.model})
      : super(key: key);

  @override
  State<AddReportScreen> createState() =>
      _AddReportScreenState(model: model);
}

class _AddReportScreenState extends State<AddReportScreen> {
  ProviderOrder model;

  _AddReportScreenState({required this.model});
  ...
  Widget build(BuildContext context) {
    ...
    cubit.model.user_id=model.user.user.id;
    cubit.model.provider_id=model.provider.user.id;
    cubit.model.order_id=model.id;
    cubit.checkData();
    ...
    return Scaffold(
      ...
      body: BlocListener<AddReportCubit, AddReportState>(
  ...
  _buildBodySection(AddReportState state) {
    String lang = EasyLocalization.of(context)!.locale.languageCode;
          ...
          children: [
            ...
            Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    initialValue: cubit.model.reason,
                    maxLines: 1,
                    autofocus: false,
                    onChanged: (text) {
                      cubit.model.reason = text;
                      cubit.checkData();
                    },
              ...
              child: Container(
                ...
                child: Stack(
                  children: [
                    ...
                    cubit.model.photo.isNotEmpty
                        ? Center(
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(1),
                        child: Image.file(
                          File(cubit.model.photo),
                          fit: BoxFit.cover,
                        ),
                      ),
                    )
