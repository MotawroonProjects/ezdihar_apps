...
import 'package:ezdihar_apps/screens/consultant_details_screen/cubit/consultant_details_cubit.dart';
...
class _ConsultantDetailsPageState extends State<ConsultantDetailsPage> {
  ...
  Widget _buildBodySection() {
    ...
    return BlocProvider(
      create: (context) {
        ConsultantDetailsCubit cubit = ConsultantDetailsCubit();
        cubit.getData(consultant_id);
        return cubit;
      },
      child: BlocBuilder<ConsultantDetailsCubit, ConsultantDetailsState>(
            ...
            return Column(
              children: [
                ...
                InkWell(
                  onTap: () {
                    Navigator.pushNamed(
                        context, AppConstant.pageRequestConsultationRoute);
                  },
                  child: Container(
                    width: width,
                    height: 56.0,
